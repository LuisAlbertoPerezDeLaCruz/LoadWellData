 ...
 * @author USUARIO
 */
public class MuestraWellPlanPerMD extends javax.swing.JDialog implements miLibreria.GlobalConstants{

    public long wellPlanId;
    public Run oRun;
    public ManejoBDI oBD;
    static DefaultTableModel modelo;
    
    public MuestraWellPlanPerMD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void cargaTabla() {
        ...
        if (rs!=null) {
            try {
                ...
                Logger.getLogger(MuestraWellPlanPerMD.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        if (cant>0) {
            ...
            for (int i=0;i<=cant-1;i++) {
                ...
                modelo.addRow(new Object[] { oWellPlanPerMD.getMd(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MuestraWellPlanPerMD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MuestraWellPlanPerMD dialog = new MuestraWellPlanPerMD(new javax.swing.JFrame(), true);
